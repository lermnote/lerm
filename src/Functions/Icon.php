...
if ( ! function_exists( 'lerm_get_icon_svg' ) ) {
	...
	function lerm_get_icon_svg( $icon, $size = 24 ) {
		...
		if ( ! class_exists( 'Lerm\\Inc\\SVG_Icons' ) || ! method_exists( 'Lerm\\Inc\\SVG_Icons', 'get_svg' ) ) {
			return '';
		}
...
if ( ! function_exists( 'lerm_get_social_link_svg' ) ) {
	...
	function lerm_get_social_link_svg( $uri, $size = 24 ) {
		...
		if ( ! class_exists( 'Lerm\\Inc\\SVG_Icons' ) || ! method_exists( 'Lerm\\Inc\\SVG_Icons', 'get_social_link_svg' ) ) {
			return '';
		}

		return Lerm\Inc\SVG_Icons::get_social_link_svg( $uri, (int) $size );
	}
}
