...
return array(
	...
	'fields'      => array(
		array(
			...
			'group_heading'    => __( 'Frontend login', 'lerm' ),
			'default'     => false,
		),
		array(
			...
			'group_heading'         => __( 'Frontend login', 'lerm' ),
			'default'          => 0,
			'choices'          => array( ThemeOptionsDefinition::class, 'page_choices' ),
			'cast'             => 'int',
		...
		array(
			...
			'group_heading'         => __( 'Registration', 'lerm' ),
			'default'          => false,
			'dependency_field' => 'frontend_login',
			'dependency_value' => '1',
		),
		...
		array(
			...
			'choices'          => array( ThemeOptionsDefinition::class, 'role_choices' ),
			'dependency_field' => 'frontend_regist',
			'dependency_value' => '1',
		),
		array(
		...
		array(
			...
			'group_heading'         => __( 'Account center', 'lerm' ),
			'default'          => false,
			'dependency_field' => 'frontend_login',
			'dependency_value' => '1',
		),
