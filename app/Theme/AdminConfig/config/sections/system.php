		...
		array(
			...
			'fields' => array(
				array(
					...
					'group_heading' => __( 'Asset mirrors', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'          => 'super_gravatar',
					...
					'group_heading' => __( 'Asset mirrors', 'lerm' ),
					'default'     => 'disable',
					'choices'     => array( ThemeOptionsDefinition::class, 'gravatar_choices' ),
				),
				array(
					'id'          => 'super_googleapis',
					'type'        => 'select',
					...
					'group_heading' => __( 'Asset mirrors', 'lerm' ),
					'default'     => 'disable',
					'choices'     => array( ThemeOptionsDefinition::class, 'google_mirror_choices' ),
				),
			),
		),
		array(
			...
			'fields' => array(
				array(
					...
					'group_heading' => __( 'Frontend delivery', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'          => 'super_optimize',
					...
					'group_heading' => __( 'Frontend delivery', 'lerm' ),
					'default'     => array(),
					'choices'     => array( ThemeOptionsDefinition::class, 'optimize_flags_choices' ),
				),
			),
		),
		array(
			...
			'fields' => array(
				array(
					...
					'group_heading' => __( 'Custom injection', 'lerm' ),
					'default'     => '',
					'rows'        => 10,
				),
				array(
		...
		array(
			...
			'fields' => array(
				array(
					...
					'group_heading' => __( 'CDN rewriting', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'               => 'new_url',
		...
		array(
			...
			'fields' => array(
				array(
					...
					'group_heading' => __( 'Mail delivery', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'               => 'smtp_options',
