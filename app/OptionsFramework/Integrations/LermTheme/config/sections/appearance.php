		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle'    => __( 'Container style', 'lerm' ),
				...
				array(
					...
					'subtitle'    => __( 'Sidebar layout', 'lerm' ),
					'default'     => 'layout-2c-r',
					'choices'     => array(
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle'    => __( 'Page background', 'lerm' ),
					'default'     => array(
				...
				array(
					...
					'subtitle'    => __( 'Header & navigation', 'lerm' ),
					'default'     => array(
						'top'    => '0',
						'bottom' => '1',
						'left'   => '0',
				...
				array(
					...
					'fields'      => array(
						array( 'id' => 'top', 'type' => 'number', 'label' => __( 'Top', 'lerm' ), 'default' => '1.5', 'min' => 0, 'step' => 0.1 ),
						array( 'id' => 'bottom', 'type' => 'number', 'label' => __( 'Bottom', 'lerm' ), 'default' => '1.5', 'min' => 0, 'step' => 0.1 ),
						array( 'id' => 'left', 'type' => 'number', 'label' => __( 'Left', 'lerm' ), 'default' => '', 'min' => 0, 'step' => 0.1 ),
						array( 'id' => 'right', 'type' => 'number', 'label' => __( 'Right', 'lerm' ), 'default' => '', 'min' => 0, 'step' => 0.1 ),
						array(
							'id'      => 'unit',
							'type'    => 'select',
							'label'   => __( 'Unit', 'lerm' ),
				...
				array(
					...
					'subtitle'    => __( 'Widget headers', 'lerm' ),
					'default'     => array(
						'color'            => '',
						'background_color' => '',
						'border_color'     => '',
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => __( 'Utility buttons', 'lerm' ),
					'default'  => true,
				),
				array(
