		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Search behaviour', 'lerm' ),
					'default'     => true,
				),
				array(
					...
					'subtitle' => __( 'Instant search', 'lerm' ),
					'default'     => 5,
					'min'         => 1,
					'max'         => 20,
					'step'        => 1,
		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Archive cards', 'lerm' ),
				...
				array(
					...
					'subtitle' => __( 'Single post meta', 'lerm' ),
				...
				array(
					...
					'subtitle' => __( 'Table of contents', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'               => 'toc_min_headings',
				...
				array(
					...
					'subtitle' => __( 'Sharing & copyright', 'lerm' ),
					'default' => 'bottom',
					'choices' => array(
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => __( 'Custom sidebars', 'lerm' ),
					'default'     => array(),
				...
				array(
					...
					'subtitle' => __( 'Sidebar assignments', 'lerm' ),
				...
				array(
					...
					'subtitle' => __( 'Widget settings', 'lerm' ),
					'default'     => 95,
					'min'         => 0,
					'max'         => 300,
					'step'        => 5,
