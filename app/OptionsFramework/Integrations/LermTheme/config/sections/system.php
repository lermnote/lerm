		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Asset mirrors', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'          => 'super_gravatar',
		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Frontend delivery', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'          => 'super_optimize',
		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Custom injection', 'lerm' ),
					'default'     => '',
					'rows'        => 10,
				),
				array(
		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'CDN rewriting', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'               => 'new_url',
		...
		array(
			...
			'fields' => array(
				array(
					...
					'subtitle' => __( 'Mail delivery', 'lerm' ),
					'default'     => false,
				),
				array(
					'id'               => 'smtp_options',
