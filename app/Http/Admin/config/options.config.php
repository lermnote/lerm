		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => __( 'Choose the default site layout, sidebar selection, and sidebar position.', 'lerm' ),
					'options'  => array(
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'desc'    => __( 'Serve WordPress core static assets from public mirrors to speed up dashboard loading.', 'lerm' ),
					'default' => false,
				),
				array(
					'id'          => 'super_gravatar',
					...
					'placeholder' => __( 'Select a Gravatar mirror service', 'lerm' ),
					'desc'        => __( 'Improve the loading speed of Gravatar avatars.', 'lerm' ),
					'options'     => array(
						'disable'                        => __( 'Disable', 'lerm' ),
						'https://cdn.sep.cc/avatar/'     => __( 'SEP mirror service', 'lerm' ),
						'https://cravatar.cn/avatar/'    => __( 'Cravatar mirror service', 'lerm' ),
						'https://sdn.geekzu.org/avatar/' => __( 'Geekzu mirror service', 'lerm' ),
						'https://gravatar.loli.net/avatar/' => __( 'Loli mirror service', 'lerm' ),
						'https://weavatar.com/avatar/'   => __( 'WeAvatar mirror service', 'lerm' ),
					),
					'default'     => 'disable',
				),
				array(
					'id'          => 'super_googleapis',
					'type'        => 'select',
					'title'       => __( 'Google Fonts acceleration', 'lerm' ),
					'placeholder' => __( 'Select a Google Fonts mirror service', 'lerm' ),
					'desc'        => __( 'Enable this only if Google Fonts are loaded on your site.', 'lerm' ),
					'options'     => array(
						'disable' => __( 'Disable', 'lerm' ),
						'geekzu'  => __( 'Geekzu mirror service', 'lerm' ),
						'loli'    => __( 'Loli mirror service', 'lerm' ),
						'ustc'    => __( 'USTC mirror service', 'lerm' ),
					),
					'default'     => 'disable',
				),
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'desc'    => __( 'Breadcrumb link separator, for example: \'/\' or \'>\'.', 'lerm' ),
					'default' => '/',
				),
				array(
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'type'        => 'select',
					'title'       => __( 'Select Frontend Login Page', 'lerm' ),
					'placeholder' => 'Select user center page',
					'options'     => 'pages',
					'query_args'  => array(
						'posts_per_page' => -1,
					),
