	...
	array(
		...
		'fields' => array(
			array(
				...
				'type'     => 'code_editor',
				'title'    => __( 'Custom CSS', 'lerm' ),
				'subtitle' => __( 'CSS entered here is output in a style tag in the page head.', 'lerm' ),
				'settings' => array(
					'theme' => 'mbo',
					'mode'  => 'css',
				),
...
// ═════════════════════════════════════════════════════════════════════════════
// ──────────────────────────────────────────────────────────────────────────────
// SUPPLEMENTARY SECTIONS — added below existing config
// ──────────────────────────────────────────────────────────────────────────────
// ═════════════════════════════════════════════════════════════════════════════

// ─────────────────────────────────────────────────────────────────────────────
// Appearance › Header (behavior)
// ─────────────────────────────────────────────────────────────────────────────
if ( class_exists( 'CSF' ) ) :
		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'type'       => 'subheading',
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'content'    => __( 'Dark colour palette', 'lerm' ),
				),
				array(
					'id'         => 'dark_bg_body',
					'type'       => 'color',
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'title'      => __( 'Body background', 'lerm' ),
					'subtitle'   => __( 'Page-level background in dark mode.', 'lerm' ),
					'default'    => '#1a1b1e',
				),
				array(
					'id'         => 'dark_bg_card',
					...
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'title'      => __( 'Card / content background', 'lerm' ),
					'subtitle'   => __( 'Background for cards and post content areas.', 'lerm' ),
					'default'    => '#25262b',
				),
				array(
					'id'         => 'dark_bg_header',
				...
				array(
					...
					'type'       => 'color',
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'title'      => __( 'Body text colour', 'lerm' ),
					'default'    => '#c1c2c5',
				),
				array(
					'id'         => 'dark_text_muted',
					'type'       => 'color',
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'title'      => __( 'Muted / secondary text', 'lerm' ),
					'subtitle'   => __( 'Used for meta info, captions, placeholders.', 'lerm' ),
					'default'    => '#909296',
				),
				array(
					'id'         => 'dark_border',
				...
				array(
					...
					'type'       => 'color',
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'title'      => __( 'Footer widgets background', 'lerm' ),
					'default'    => '#141517',
				),
				array(
					'id'         => 'dark_bar_bg',
					'type'       => 'color',
					'dependency' => array( 'dark_mode_enable', '==', 'true' ),
					'title'      => __( 'Footer bar (copyright strip) background', 'lerm' ),
					'default'    => '#101113',
				),
			),
		)
