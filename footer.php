<footer class="footer mt-3" itemscope="" itemtype="http://schema.org/WPFooter">
	...
	<div class="btn-group-vertical position-fixed toolbar" style="bottom: 4rem;right: 1rem">
		<a class="tool-btn btn btn-custom" target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=825641026&site=qq&menu=yes" data-toggle="tooltip" data-placement="left" title="QQ 在线咨询"  role="button"><i class="fa fa-qq"></i></a>
		<a class="tool-btn btn btn-custom" id="scroll-up" href="javascript:void(0);"  data-toggle="tooltip" data-placement="left" title="飞回顶部"  role="button"><i class="fa fa-chevron-up" ></i></a>
	</div>
