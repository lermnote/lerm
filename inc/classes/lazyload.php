	...
	private static function add_lazy_data_attributes( $image ) {
		if ( stripos( $image, 'srcset=' ) ) {
			if ( ! stripos( $image, 'data-srcset=' ) ) {
				$regexp  = "/<img([^<>]*)srcset=['\"]([^<>'\"]*)['\"]([^<>]*)>/i";
				$replace = '<img$1srcset="data:image/gif;base64," data-src="$2" data-srcset="$2"$3>';
			}
		} else {
			$regexp  = "/<img([^<>]*)src=['\"]([^<>'\"]*)\.(bmp|gif|jpeg|jpg|png)([^<>'\"]*)['\"]([^<>]*)>/i";
			$replace = '<img$1src="data:image/gif;base64," data-src="$2.$3$4"$5>';
		}
