...
class Lerm_Carousel {
	...
	public function render() {
		...
		foreach ( $this->slides as $key => $slide ) {
			...
			$image      = sprintf( '<img class="d-block img-fluid w-100" src="%1$s" alt="%2$s" width="%3$s" height="%4$s">', $slide['image']['url'], $slide['title'], $slide['image']['width'], $slide['image']['height'] );
		...
		?>
		<div id="lermSlides" class="carousel slide carousel-fade" data-ride="carousel">
