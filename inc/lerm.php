...
require LERM_DIR . 'inc/admin/class-nav-menu.php';
...
require LERM_DIR . 'inc/admin/related.php';
// Load shortcode files
// require LERM_DIR . 'inc/admin/shortcode.php';

// Load the template files
require LERM_DIR . 'inc/admin/template-comment.php';
