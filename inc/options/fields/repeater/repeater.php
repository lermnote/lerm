    ...
    class CSF_Field_repeater extends CSF_Fields
    {
        ...
        'button_title' => '<i class="fa fa-plus-circle"></i>',
            ...
            if ($this->parent && preg_match('/'. preg_quote('['. $this->field['id'] .']') .'/', $this->parent)) {
                ...
                echo '<i class="csf-repeater-remove csf-confirm fa fa-times" data-confirm="'. esc_html__('Are you sure to delete this item?', 'lerm') .'"></i>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
                ...
                echo '<div class="csf-repeater-alert csf-repeater-max">'. esc_html__('You can not add more than', 'lerm') .' '. $args['max'] .'</div>';
                echo '<div class="csf-repeater-alert csf-repeater-min">'. esc_html__('You can not remove less than', 'lerm') .' '. $args['min'] .'</div>';
