	...
	class CSF_Field_icon extends CSF_Fields {
		...
		public function render() {
			...
			$args = wp_parse_args(
				$this->field,
				array(
					'button_title' => esc_html__( 'Add Icon', 'lerm' ),
					'remove_title' => esc_html__( 'Remove Icon', 'lerm' ),
				)
			);
		  ...
		  <div class="csf-modal-table-cell">
			...
			<div class="csf-modal-inner">
			  ...
			  <div class="csf-modal-header">
				<input type="text" placeholder="<?php esc_attr_e( 'Search...', 'lerm' ); ?>" class="csf-icon-search" />
			  </div>
