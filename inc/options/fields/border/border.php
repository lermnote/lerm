  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'lerm' ),
        'right_placeholder'  => esc_html__( 'right', 'lerm' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'lerm' ),
        'left_placeholder'   => esc_html__( 'left', 'lerm' ),
        'all_placeholder'    => esc_html__( 'all', 'lerm' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'lerm' ),
        'dashed'    => esc_html__( 'Dashed', 'lerm' ),
        'dotted'    => esc_html__( 'Dotted', 'lerm' ),
        'double'    => esc_html__( 'Double', 'lerm' ),
        'inset'     => esc_html__( 'Inset', 'lerm' ),
        'outset'    => esc_html__( 'Outset', 'lerm' ),
        'groove'    => esc_html__( 'Groove', 'lerm' ),
        'ridge'     => esc_html__( 'ridge', 'lerm' ),
