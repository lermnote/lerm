...
if (! class_exists('CSF_Field_group')) {
    class CSF_Field_group extends CSF_Fields
    {
        ...
        'min'                    => 0,
        'fields'                 => array(),
        'button_title'           => esc_html__('Add New', 'lerm'),
        ...
        'accordion_title_auto'   => true,
            ...
            if (! empty($this->parent) && preg_match('/'. preg_quote('['. $this->field['id'] .']') .'/', $this->parent)) {
                echo '<div class="csf-notice csf-notice-danger">'. esc_html__('Error: Nested field id can not be same with another nested field id.', 'lerm') .'</div>';
            } else {
                ...
                echo '<i class="csf-cloneable-remove csf-confirm fa fa-times" data-confirm="'. esc_html__('Are you sure to delete this item?', 'lerm') .'"></i>';
                echo '</div>';
                ...
                echo '<div class="csf-cloneable-alert csf-cloneable-max">'. esc_html__('You can not add more than', 'lerm') .' '. $args['max'] .'</div>';
                echo '<div class="csf-cloneable-alert csf-cloneable-min">'. esc_html__('You can not remove less than', 'lerm') .' '. $args['min'] .'</div>';
