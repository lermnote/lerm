	...
	class CSF_Field_typography extends CSF_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_family'] ) ) {
				...
				echo '<div class="csf--title">' . esc_html__( 'Font Family', 'lerm' ) . '</div>';
				echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'lerm' ) );
				echo '</div>';
			}
			...
			if ( ! empty( $args['backup_font_family'] ) ) {
				...
				echo '<div class="csf--title">' . esc_html__( 'Backup Font Family', 'lerm' ) . '</div>';
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<div class="csf--title">' . esc_html__( 'Font Style', 'lerm' ) . '</div>';
				echo '<select class="csf--font-style-select" data-placeholder="Default">';
				echo '<option value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'lerm' ) : '' ) . '</option>';
				...
				if ( ! empty( $args['extra_styles'] ) ) {
					...
					echo ( ! $this->chosen ) ? '<div class="csf--title">' . esc_html__( 'Load Extra Styles', 'lerm' ) . '</div>' : '';
					$placeholder = ( $this->chosen ) ? esc_html__( 'Load Extra Styles', 'lerm' ) : esc_html__( 'Default', 'lerm' );
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo '<div class="csf--title">' . esc_html__( 'Subset', 'lerm' ) . '</div>';
				$subset = ( is_array( $this->value['subset'] ) ) ? $this->value['subset'] : array_filter( (array) $this->value['subset'] );
				echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'lerm' ), $args['multi_subset'] );
				echo '</div>';
			}
			...
			if ( ! empty( $args['text_align'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Text Align', 'lerm' ) . '</div>';
				echo $this->create_select(
					array(
						'inherit' => esc_html__( 'Inherit', 'lerm' ),
						'left'    => esc_html__( 'Left', 'lerm' ),
						'center'  => esc_html__( 'Center', 'lerm' ),
						'right'   => esc_html__( 'Right', 'lerm' ),
						'justify' => esc_html__( 'Justify', 'lerm' ),
						'initial' => esc_html__( 'Initial', 'lerm' ),
					),
					'text-align',
					esc_html__( 'Default', 'lerm' )
				);
			...
			if ( ! empty( $args['font_variant'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Font Variant', 'lerm' ) . '</div>';
				echo $this->create_select(
					array(
						'normal'         => esc_html__( 'Normal', 'lerm' ),
						'small-caps'     => esc_html__( 'Small Caps', 'lerm' ),
						'all-small-caps' => esc_html__( 'All Small Caps', 'lerm' ),
					),
					'font-variant',
					esc_html__( 'Default', 'lerm' )
				);
			...
			if ( ! empty( $args['text_transform'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Text Transform', 'lerm' ) . '</div>';
				echo $this->create_select(
					array(
						'none'       => esc_html__( 'None', 'lerm' ),
						'capitalize' => esc_html__( 'Capitalize', 'lerm' ),
						'uppercase'  => esc_html__( 'Uppercase', 'lerm' ),
						'lowercase'  => esc_html__( 'Lowercase', 'lerm' ),
					),
					'text-transform',
					esc_html__( 'Default', 'lerm' )
				);
			...
			if ( ! empty( $args['text_decoration'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Text Decoration', 'lerm' ) . '</div>';
				echo $this->create_select(
					array(
						'none'               => esc_html__( 'None', 'lerm' ),
						'underline'          => esc_html__( 'Solid', 'lerm' ),
						'underline double'   => esc_html__( 'Double', 'lerm' ),
						'underline dotted'   => esc_html__( 'Dotted', 'lerm' ),
						'underline dashed'   => esc_html__( 'Dashed', 'lerm' ),
						'underline wavy'     => esc_html__( 'Wavy', 'lerm' ),
						'underline overline' => esc_html__( 'Overline', 'lerm' ),
						'line-through'       => esc_html__( 'Line-through', 'lerm' ),
					),
					'text-decoration',
					esc_html__( 'Default', 'lerm' )
				);
			...
			if ( ! empty( $args['font_size'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Font Size', 'lerm' ) . '</div>';
			...
			if ( ! empty( $args['line_height'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Line Height', 'lerm' ) . '</div>';
				echo '<div class="csf--input-wrap">';
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Letter Spacing', 'lerm' ) . '</div>';
				echo '<div class="csf--input-wrap">';
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				echo '<div class="csf--block">';
				echo '<div class="csf--title">' . esc_html__( 'Word Spacing', 'lerm' ) . '</div>';
				echo '<div class="csf--input-wrap">';
			...
			if ( ! empty( $args['color'] ) ) {
				...
				echo '<div class="csf--title">' . esc_html__( 'Font Color', 'lerm' ) . '</div>';
			...
			if ( ! empty( $args['custom_style'] ) ) {
				...
				echo '<div class="csf--title">' . esc_html__( 'Custom Style', 'lerm' ) . '</div>';
			...
			if ( ! wp_script_is( 'csf-webfontloader' ) ) {
				...
				if ( ! empty( $customwebfonts ) ) {
					$webfonts['custom'] = array(
						'label' => esc_html__( 'Custom Web Fonts', 'lerm' ),
						'fonts' => $customwebfonts,
					);
				}

				$webfonts['safe'] = array(
					'label' => esc_html__( 'Safe Web Fonts', 'lerm' ),
					'fonts' => apply_filters(
				...
				$webfonts['google'] = array(
					'label' => esc_html__( 'Google Web Fonts', 'lerm' ),
					'fonts' => apply_filters(
