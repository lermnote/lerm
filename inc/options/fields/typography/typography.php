    ...
    class CSF_Field_typography extends CSF_Fields
    {
        ...
        'extra-styles'       => array(),
            ...
            if (! empty($args['backup_font_family'])) {
              ...
              'Georgia, serif',
              'Palatino Linotype'
            )), 'backup-font-family', esc_html__('Default', 'lerm'));
                echo '</div>';
            }
            ...
            if (! empty($args['text_align'])) {
              ...
              'justify' => 'Justify',
              'initial' => 'Initial'
            ), 'text-align', esc_html__('Default', 'lerm'));
                echo '</div>';
            }
            ...
            ), 'font-variant', esc_html__('Default', 'lerm'));
                echo '</div>';
            }
            ...
            if (! empty($args['text_transform'])) {
              ...
              'uppercase'  => 'Uppercase',
              'lowercase'  => 'Lowercase',
            ), 'text-transform', esc_html__('Default', 'lerm'));
                echo '</div>';
            }
            ...
            ), 'text-decoration', esc_html__('Default', 'lerm'));
                echo '</div>';
            }
