...
if ( ! class_exists( 'CSF_Field_code_editor' ) ) {
  class CSF_Field_code_editor extends CSF_Fields {
    ...
    public $cdn_url = 'https://cdn.staticfile.org/codemirror/';
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-codemirror' ) ) {
        wp_enqueue_script( 'csf-codemirror', esc_url( $this->cdn_url . '/'. $this->version .'/codemirror.min.js' ), array( 'lerm' ), $this->version, true );
