...
function social_link_icon_classes( $block_content, $block ) {
	...
	$custom_svgs = array(
		'facebook'  => array(
			...
			'svg'     => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="#4267B2"><path d="M22.675 0H1.325C.592 0 0 .593 0 1.326v21.348C0 23.407.592 24 1.325 24h11.495v-9.293H9.691v-3.622h3.129V8.413c0-3.1 1.894-4.785 4.659-4.785 1.325 0 2.462.099 2.794.143v3.24l-1.917.001c-1.504 0-1.796.715-1.796 1.764v2.311h3.587l-.467 3.622h-3.12V24h6.116c.733 0 1.325-.593 1.325-1.326V1.326C24 .593 23.407 0 22.675 0z"/></svg>',
		),
		'twitter'   => array(
			'domains' => array( 'twitter.com', 't.co' ),
			'svg'     => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="#1DA1F2"><path d="M23.444 4.834c-.835.37-1.73.62-2.666.733a4.674 4.674 0 0 0 2.05-2.575 9.33 9.33 0 0 1-2.956 1.13 4.673 4.673 0 0 0-7.963 4.26 13.265 13.265 0 0 1-9.627-4.876 4.673 4.673 0 0 0 1.446 6.229 4.662 4.662 0 0 1-2.117-.584v.058a4.673 4.673 0 0 0 3.745 4.579 4.68 4.68 0 0 1-2.111.08 4.675 4.675 0 0 0 4.367 3.24 9.367 9.367 0 0 1-5.795 2.002c-.378 0-.752-.022-1.122-.065a13.207 13.207 0 0 0 7.17 2.1c8.598 0 13.303-7.123 13.303-13.303 0-.202-.004-.403-.013-.602a9.488 9.488 0 0 0 2.334-2.418z"/></svg>',
		),
		'instagram' => array(
			'domains' => array( 'instagram.com', 'instagr.am' ),
			'svg'     => '<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="#C13584"><path d="M7.75 0h8.5C20.4 0 24 3.6 24 8.25v8.5c0 4.65-3.6 8.25-8.25 8.25h-8.5C3.6 25 0 21.4 0 16.75v-8.5C0 3.6 3.6 0 7.75 0zm4.25 6.85a5.9 5.9 0 1 0 0 11.8 5.9 5.9 0 0 0 0-11.8zM3.45 7.8c0 .91.73 1.65 1.65 1.65h13.8c.91 0 1.65-.73 1.65-1.65V3.6c0-.91-.73-1.65-1.65-1.65H5.1c-.91 0-1.65.73-1.65 1.65v4.2z"/></svg>',
		),
		'weibo'     => array(
