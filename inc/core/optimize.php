...
class Optimize {
	 ...
	 *
	 * @param string $reply_class CSS class.
	 *
	 * @return string Updated CSS class.
	 */
	public static function replace_reply_link_class( $reply_class ) {
		return str_replace( 'class=\'', 'class=\'btn btn-sm btn-custom ', $reply_class );
	}
